  ...
  return (
    <div className="relative pt-16 pb-24 px-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-center mb-10 leading-none text-brand-beige drop-shadow-md">
          Turn Your Fridge
          <br />
          <span className="bg-linear-to-r from-brand-beige to-brand-light bg-clip-text text-transparent leading-none">
            Into a Feast.
          </span>
        </h1>
        <p className="text-brand-beige text-center text-base md:text-xl max-w-2xl mb-12 font-medium drop-shadow-sm">
