...
const Community = () => {
    ...
    return (
        <div className="min-h-screen bg-brand-beige text-brand-dark selection:bg-brand-accent/30">
            {/* Header */}
            ...
            <main className="max-w-7xl mx-auto px-6 py-12 min-h-[60vh]">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start mb-14">
                    ...
                    {/* Search Bar */}
                    <div className="flex items-center bg-[#CEDEBD36] border border-[#95B97480] rounded-full h-12 px-5 w-full md:w-80 group focus-within:border-brand-accent transition-all shadow-sm">
